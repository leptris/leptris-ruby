# Leptris v1.1.0 - Implementation Status Tracker
...
#### Fixed Test
- **File**: `spec/leptris/element_xpath_spec.rb:252`
...
- `spec/leptris/element_xpath_spec.rb:252` - Removed pending marker

#### Success Criteria
- [x] Test `spec/leptris/element_xpath_spec.rb:252` passes
...
```ruby
# lib/leptris/ffi/bridge.rb
str = Leptris::FFI.leptris_xpath_result_as_string(result_ptr)
str.force_encoding(Encoding::UTF_8) if str
```

**Fixed Tests**:
1. ✅ `spec/leptris/element_xpath_spec.rb:1111` - UTF-8 character counting
2. ✅ `spec/leptris/element_xpath_spec.rb:1118` - Mixed ASCII/UTF-8
...
```c
if (delim[0] == '\0') {
    result->value.string_value = leptris_strdup("");  // Was: leptris_strdup(str)
}
```

#### Files Modified
- `lib/src/xpath/functions.c` - Negative position logic + substring-before fix
- `lib/leptris/ffi/bridge.rb` - UTF-8 encoding fix
- `spec/leptris/element_xpath_spec.rb` - Corrected test expectation + removed pending markers
...
```bash
# Axis syntax test
bundle exec rspec spec/leptris/element_xpath_spec.rb:252

# Substring tests
bundle exec rspec spec/leptris/element_xpath_spec.rb:1064
bundle exec rspec spec/leptris/element_xpath_spec.rb:1111
bundle exec rspec spec/leptris/element_xpath_spec.rb:1118

# All pending tests
bundle exec rspec spec/leptris/element_xpath_spec.rb:252 \
  spec/leptris/element_xpath_spec.rb:1064 \
