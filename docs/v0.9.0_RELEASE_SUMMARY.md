# Leptris v0.9.0 - Release Summary
...
Leptris v0.9.0 is a performance and API enhancement release focused on namespace handling and XPath query optimization. This release introduces the foundation for custom namespace registration while delivering significant performance improvements to existing functionality.
...
**Files Modified**:
- `lib/leptris/document.rb` - Added namespaces parameter to Document#xpath
- `lib/leptris/element.rb` - Added namespaces parameter to Element#xpath
...
**Updated Files**:
- `lib/leptris/version.rb` - Version constant updated to 0.9.0
...
- **GitHub Repository**: https://github.com/leptris/leptris
- **RubyGems**: https://rubygems.org/gems/leptris

## Conclusion

Leptris v0.9.0 represents a solid incremental improvement focusing on:
