# Leptris v1.1.0 - Final Continuation Plan
...
- Files: [`lib/src/xpath/functions.c`](../lib/src/xpath/functions.c), [`lib/leptris/ffi/bridge.rb`](../lib/leptris/ffi/bridge.rb)
...
- Update `lib/leptris/version.rb` → "1.1.0"
- Build gem: `gem build leptris.gemspec`
...
git tag -a v1.1.0 -m "Leptris v1.1.0"
```
...
- Publish gem: `gem push leptris-1.1.0.gem`
...
**Ruby FFI Bridge** (`lib/leptris/ffi/bridge.rb`):
1. UTF-8 encoding enforcement for string results

**Test Suite** (`spec/leptris/element_xpath_spec.rb`):
...
3. `lib/leptris/version.rb` - Bump to "1.1.0"
...
# Expected: Successfully built RubyGem: leptris-1.1.0.gem
