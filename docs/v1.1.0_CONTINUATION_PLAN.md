# Leptris v1.1.0 - Edge Case Resolution Plan
...
- **Location**: `spec/leptris/element_xpath_spec.rb:252`
...
- **Location**: `spec/leptris/element_xpath_spec.rb:1064`
...
1. `substring() counts UTF-8 characters not bytes`
   - **Location**: `spec/leptris/element_xpath_spec.rb:1111`
...
2. `substring() handles mixed ASCII and UTF-8`
   - **Location**: `spec/leptris/element_xpath_spec.rb:1118`
...
2. Possibly `lib/leptris/ffi/` - FFI string conversion
...
```ruby
# In lib/leptris/xpath.rb or similar
...
bundle exec rspec spec/leptris/element_xpath_spec.rb:252   # axis::name
bundle exec rspec spec/leptris/element_xpath_spec.rb:1064  # negative position
bundle exec rspec spec/leptris/element_xpath_spec.rb:1111  # UTF-8 encoding 1
bundle exec rspec spec/leptris/element_xpath_spec.rb:1118  # UTF-8 encoding 2
...
### Test Files
- `spec/leptris/element_xpath_spec.rb` - Main XPath tests
